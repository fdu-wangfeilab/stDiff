...
def main():
    ...
    parser.add_argument('--epoch', type=int, help='number of training epochs, at least 3000', default=3000)
    parser.add_argument('--lr', type=float, help='learning rate', default=0.0001)
    parser.add_argument('--bs', type=int, help='batch size per iteration', default=256) # 56
    ...
    parser.add_argument('--factors', type=str, help='factor of Unet', default = '3,4,5,1') # 3 4 5 1   2 3 4 1 
    parser.add_argument('--down_block_dim', type=str, help='down_block_dim of Unet', default = '32,128,256,512') # 32 128 256 512
